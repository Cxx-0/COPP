        ...
        while len(H) != 0:
            ...
            if label == 0 and envt.current_time - envt.last_time > envt.action_unit_time:  
                ...
                if envt.delta_time > 0:
                    real_reward = 0.9*now_all_car_num_ + 0.1*np.log(envt.delta_time) 
                else:
                ...
                for edge_count, edge in enumerate(envt.use_edge):
                    ...
                    observation = envt.node_attr_index[edge[0]]+[car_number_beishu] 
                ...
                for edge_count, edge in enumerate(envt.use_edge):
                    ...
                    if len(envt.temp_obs) != 0 and episode > 0:  
